...
const ACTION_LABELS: Record<string, string> = {
  ...
  "problem_report.create":         "პრობლემა დაფიქსირდა",
  "problem_report.update":         "პრობლემა განახლდა",
  "problem_report.delete":         "პრობლემა წაიშალა",
...
const ENTITY_OPTIONS = [
  ...
  { value: "problem_report",    label: "პრობლემა" },
